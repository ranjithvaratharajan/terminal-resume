  ...
  experience: [
    {
      ...
      description:
        "Leading the frontend modernization initiative for WPD/CMA MUT applications, rewriting legacy UI screens into a responsive Angular architecture.",
      highlights: [
        "Rewriting legacy UI screens into modern, responsive Angular architecture",
        "Mentoring 4+ junior developers (ASEs) in Angular best practices",
        "Collaborating with client support teams to troubleshoot complex production issues",
        "Deploying rapid fixes that significantly reduced system downtime",
      ],
      technologies: [
        "Angular",
        "TypeScript",
